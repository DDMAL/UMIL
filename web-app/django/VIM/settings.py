...
WIKIDATA_OAUTH_URL = os.getenv("WIKIDATA_OAUTH_URL")
WIKIDATA_REDIRECT_URI = os.getenv("WIKIDATA_REDIRECT_URI")
WIKIDATA_CLIENT_APP_KEY = os.getenv("WIKIDATA_CLIENT_APP_KEY")
WIKIDATA_CLIENT_APP_SECRET = os.getenv("WIKIDATA_CLIENT_APP_SECRET")
WIKIBASE_ACCESS_TOKEN = os.getenv("WIKIBASE_ACCESS_TOKEN")
